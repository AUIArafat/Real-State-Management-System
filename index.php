  ...
  <div class="intro intro-carousel">
    <div id="carousel" class="owl-carousel owl-theme">
      <?php 
          ...
          $query=mysqli_query($con,"SELECT * FROM properties LIMIT 3");
      ...
      ?> 
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(admin1/images/property_image/<?php echo $img;?>)">
                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <h1 class="intro-title mb-4">
                      <span class="color-b" style="color: white;" ><?php echo $property_title?></h1>

                        <h3 class="intro-title mb-2">
                      <span class="color-b" style="color: orange;font-size:25px;margin-top: -20px;" ><?php echo $address ?></h3>
      ...
      <?php } ?>
      <!-- <div class="carousel-item-a intro-item bg-image" style="background-image: url(img/b.jpg)">
        <div class="overlay overlay-a"></div>
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="container">

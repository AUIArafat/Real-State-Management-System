        ...
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">Friends Real <span class="color-b">Estate ltd</span></h3>
            </div>
            <div class="w-body-a">
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">Friends Real <span class="color-b">Estate ltd</span></span> All Rights Reserved.
            </p>
          </div>
          <div class="credits">
            <!--
